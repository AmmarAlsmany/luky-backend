@extends('layouts.vertical', ['title' => __('common.create') . ' ' . __('common.page')])
...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4">
            ...
            {{ __('common.create') . ' ' . __('common.page') }}
        </h4>
                    ...
                    <div class="card-body">
                        <form action="{{ route('static-pages.store') }}" method="POST" id="staticPageForm" onsubmit="return syncQuillContent();">
                            ...
                            <div class="mb-3">
                                ...
                                <div id="editor_en" style="height: 300px;">{!! old('content_en') !!}</div>
                            ...
                            <div class="mb-3">
                                ...
                                <div id="editor_ar" style="height: 300px;" dir="rtl">{!! old('content_ar') !!}</div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('meta_description_en') is-invalid @enderror" 
                                          id="meta_description_en" name="meta_description_en" rows="3">{{ old('meta_description_en') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('meta_description_ar') is-invalid @enderror" 
                                          id="meta_description_ar" name="meta_description_ar" rows="3" dir="rtl">{{ old('meta_description_ar') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('is_published') is-invalid @enderror" id="is_published" name="is_published" required>
                                    <option value="0" {{ old('is_published') == '0' ? 'selected' : '' }}>{{ __('common.draft') }}</option>
                                    <option value="1" {{ old('is_published') == '1' ? 'selected' : '' }}>{{ __('common.published') }}</option>
                                </select>
                                @error('is_published')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
